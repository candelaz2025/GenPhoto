...
const categorizedPrompts: Record<string, PromptExample[]> = {
    "ยอดนิยม": [
        examplePrompts[0], examplePrompts[2], examplePrompts[7], examplePrompts[4], 
        examplePrompts[5], examplePrompts[20], examplePrompts[24], examplePrompts[26]
    ],
    "3D & เรนเดอร์": [
        examplePrompts[0], examplePrompts[1], examplePrompts[12], examplePrompts[18], 
        examplePrompts[52], examplePrompts[68]
    ],
    "สมจริง & ภาพถ่าย": [
        examplePrompts[2], examplePrompts[4], examplePrompts[8], examplePrompts[14], 
        examplePrompts[16], examplePrompts[17], examplePrompts[24], examplePrompts[34], 
        examplePrompts[37], examplePrompts[38], examplePrompts[41], examplePrompts[44], 
        examplePrompts[64], examplePrompts[70], examplePrompts[82]
    ],
    "แฟนตาซี & ไซไฟ": [
        examplePrompts[5], examplePrompts[6], examplePrompts[7], examplePrompts[10],
        examplePrompts[25], examplePrompts[26], examplePrompts[29], examplePrompts[32],
        examplePrompts[40], examplePrompts[50], examplePrompts[66], examplePrompts[72],
        examplePrompts[81], examplePrompts[83], examplePrompts[85]
    ],
    "ศิลปะ & ภาพวาด": [
        examplePrompts[9], examplePrompts[20], examplePrompts[36], examplePrompts[39],
        examplePrompts[45], examplePrompts[51], examplePrompts[67], examplePrompts[74],
        examplePrompts[80]
    ],
    "ตัวละคร & ผู้คน": [
        examplePrompts[18], examplePrompts[25], examplePrompts[31], examplePrompts[36],
        examplePrompts[43], examplePrompts[65], examplePrompts[69], examplePrompts[73],
        examplePrompts[77]
    ],
    "ทิวทัศน์ & สถาปัตยกรรม": [
        examplePrompts[3], examplePrompts[5], examplePrompts[7], examplePrompts[8],
        examplePrompts[12], examplePrompts[26], examplePrompts[29], examplePrompts[30],
        examplePrompts[46], examplePrompts[54], examplePrompts[61], examplePrompts[71],
        examplePrompts[82]
    ],
    "น่ารัก & สติกเกอร์": [
        examplePrompts[13], examplePrompts[15], examplePrompts[53], examplePrompts[75]
    ],
    "แนวคิด & นามธรรม": [
        examplePrompts[19], examplePrompts[23], examplePrompts[27], examplePrompts[39],
        examplePrompts[45], examplePrompts[51], examplePrompts[68]
    ]
};
...
const PromptExamplesModal: React.FC<PromptExamplesModalProps> = ({ isOpen, onClose, onSelectPrompt }) => {
  ...
  useEffect(() => {
    ...
    let prompts = categorizedPrompts[activeCategory] || [];
    ...
    >
      ...
      >
        ...
        <div className="flex-shrink-0 mb-4 space-y-4">
            <input
                type="text"
                placeholder={`ค้นหาในหมวดหมู่ "${activeCategory}"...`}
                value={searchTerm}
        ...
        <div className="overflow-y-auto pr-2 -mr-4 flex-grow">
            {filteredPrompts.length > 0 ? (
                ...
                <div className="col-span-full text-center py-10 text-gray-400 flex flex-col items-center justify-center h-full">
                    <p className="text-lg">ไม่พบ Prompt ที่ตรงกัน</p>
